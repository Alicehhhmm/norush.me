...
export const Logon: FC<LogonProps> = ({
  bgfill,
  fill = 'currentColor',
  ...props
}) => (
  ...
  >
    ...
    />
    <path
      d="M55.4007 92.543L33 78.8841V115.49C36.8245 126.417 46.1126 126.417 55.4007 126.417V92.543Z"
      fill={fill}
    />
    <path
      d="M111.675 74.5132V39C126.536 39 131.709 47.3775 132.437 51.5662V86.5331L111.675 74.5132Z"
      fill={fill}
    />
  </svg>
);

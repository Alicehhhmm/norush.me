...
export default {
  ...
  rules: {
    // Enforces Element Class Names to be camelCase or kebab-case (for Tailwind utilities)
    'selector-class-pattern': [
      /^(?:[a-z]+(?:[A-Z][a-z]*)*)|(?:[a-z]+(?:-[a-z]+)*)$/,
      { message: s => `Expected '${s}' to be in camelCase or kebab-case` },
    ],
    ...
    // Disable Tailwind v4 specific rules

                ...
                <div className="space-y-1">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      {section.icon && (
                        <WithIcon icon={section.icon} className="h-4 w-4" />
                      )}
                  ...
                  <div
                    className={cn(
                      'ml-4 overflow-hidden border-l pl-2',
                      'ease-ease-in-out transition-[max-height,opacity] duration-300',
                      isExpanded(section.meunKey)

/**
 * @ description:
 * this file is used to export the default implementations of the Next.js dynamic page functions
 * such as getStaticProps, getStaticPaths, and generateMetadata
 * these functions are used in the [locale]/page.tsx file to provide the necessary data for rendering the page
 *
 * @update 2026-03-13
 */
...
export const renderPage = props => {
  ...
  setGlobClientContext(props.context);
